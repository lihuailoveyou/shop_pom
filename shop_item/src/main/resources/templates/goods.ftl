...
<head>
	<#--因为freemarker没有内置对象帮我
		们生成这个路径，所以我们通过contrller那边生成的context上下文对象传过来生成路径
	-->
			...
			<div class="shop_goods_show_left">
				...
				<div id="preview">
					<div class=jqzoom id="spec-n1" onClick="window.open('/')">
						<IMG height="350" src="http://192.168.81.188/${goods.gimage}" jqimg="http://192.168.81.188/${goods.gimage}">
						</div>
						<div id="spec-n5">
							<div class=control id="spec-left">
								<img src="http://192.168.81.188${goods.gimage}" />
							</div>
							<div id="spec-list">
								<ul class="list-h">
									<li><img src="http://192.168.81.188${goods.gimage}"> </li>
								</ul>
							</div>
