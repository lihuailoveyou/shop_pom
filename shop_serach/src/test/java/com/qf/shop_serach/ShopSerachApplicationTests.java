...
@SpringBootTest
public class ShopSerachApplicationTests {
    ...
    public void addIndex() throws IOException, SolrServerException {
        ...
        /*for(int i = 87; i <= 100; i++) {
            ...
            document.addField("ginfo", "手机描述" + i);
            document.addField("gprice", 1999.00 + i);
            document.addField("gcount", 100 + i);
            document.addField("gimage", "group1/M00/00/00/wKhRvFv3f4WARDirAACmW7wZHgw932.jpg");
        ...
        SolrInputDocument document = new SolrInputDocument();
        document.addField("id", 90);
        document.addField("gtitle", "小米");
        document.addField("ginfo", "手机描述");
        document.addField("gprice", 1998.00);
